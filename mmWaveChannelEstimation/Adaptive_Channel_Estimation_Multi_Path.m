...
%
% Brief description: This code estimates a single-user mmWave channel with a geometric 
% channel model as described in the paper - A. Alkhateeb, O. ElAyach, G. Leus, and 
% R. W. Heath Jr., "Channel Estimation and Hybrid Precoding for Millimeter Wave Cellular 
% Systems," IEEE Journal of Selected Topics in Signal Processing, vol.8, no.5, pp.831-846, 
% Oct. 2014.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Notes
% (1) To generate the Exhaustive search solution: 
% put K_BS=G_BS/Num_paths_est, K_MS=G_MS/Num_paths_est
%--------------------------------------------------------------------------
% (2) log(G_BS/Num_Paths_est)/log(K_BS) and log(G_MS/Num_paths_est)/log(K_MS) 
% must be integers (Look below for the definitions of each of them)
